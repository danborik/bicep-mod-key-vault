...
module keyVault_accessPolicies 'modules/access-policy/main.bicep' = if (!empty(accessPolicies)) {
...
module keyVault_secrets 'modules/secret/main.bicep' = [
...
module keyVault_keys 'modules/key/main.bicep' = [
...
module keyVault_privateEndpoints 'br:acrcitinfrbicepmodules.azurecr.io/private-endpoint:v1.0.0' = [
